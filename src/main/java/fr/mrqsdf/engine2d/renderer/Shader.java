...
public class Shader {
    ...
    public Shader(String  filepath) {
        ...
        try {
            ...
            if (firstPattern.equals("vertex")) {
                ...
                assert false : "Error: Shader type '" + firstPattern + "' is not supported";
            }
            ...
            if (secondPattern.equals("vertex")) {
                ...
                assert false : "Error: Shader type '" + secondPattern + "' is not supported";
            }
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public void use() {
        if (!beingUsed)glUseProgram(shaderProgramID);
        beingUsed = true;
    }
    ...
    public void uploadMat4f(String varName, Vector4f vec){
        int varLocation = glGetUniformLocation(shaderProgramID, varName);
        use();
