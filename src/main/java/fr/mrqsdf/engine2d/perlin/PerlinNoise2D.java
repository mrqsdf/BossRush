package fr.mrqsdf.engine2d.perlin;
...
public class PerlinNoise2D {
    ...
    private static BufferedImage image = new BufferedImage(EngineSettings.PERLIN_SIZE, EngineSettings.PERLIN_SIZE, BufferedImage.TYPE_INT_RGB);
    public static BufferedImage getNoiseImage(long seed){
        time = seed;
        for(int y = 0; y < EngineSettings.PERLIN_SIZE; y++){
            for(int x = 0; x < EngineSettings.PERLIN_SIZE; x++){
                double dx = (double) x / EngineSettings.PERLIN_SIZE;
                double dy = (double) y / EngineSettings.PERLIN_SIZE;
                int frequency = 6;
    ...
    public static double getNoise(float x, float y){
        return noise(x, y);
    }
